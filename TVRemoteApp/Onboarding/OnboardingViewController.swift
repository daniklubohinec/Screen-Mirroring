...
final class OnboardingViewController: UIViewController, UIScrollViewDelegate {
    ...
    private lazy var footer: UIView = {
        ...
        termOfUse.setAttributedTitle(NSAttributedString(string: R.string.localizable.terms_Of_Use(), attributes: [.underlineStyle: NSUnderlineStyle.single.rawValue]), for: .normal)
        ...
        privacy.setAttributedTitle(NSAttributedString(string: R.string.localizable.privacy_Policy(), attributes: [.underlineStyle: NSUnderlineStyle.single.rawValue]), for: .normal)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if !review, pageControl.numberOfPages == 2  {
